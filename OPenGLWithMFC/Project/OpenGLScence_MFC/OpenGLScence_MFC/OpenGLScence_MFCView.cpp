...
int COpenGLScence_MFCView::DrawGLScene()
{
	manager->render();
	glFlush();
	return TRUE;                                
...
void COpenGLScence_MFCView::OnLButtonDown(UINT nFlags, CPoint point)
{
...
void COpenGLScence_MFCView::OnLButtonUp(UINT nFlags, CPoint point)
{
	// TODO:  在此添加消息处理程序代码和/或调用默认值
...
BOOL COpenGLScence_MFCView::OnEraseBkgnd(CDC* pDC)
{
	// TODO:  在此添加消息处理程序代码和/或调用默认值
